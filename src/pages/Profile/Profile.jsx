          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active profile-overview" id="profile-overview" role="tabpanel">
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8">{user.r_name}</div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8">{user.r_address}</div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label">Phone</div>
                <div class="col-lg-9 col-md-8">{user.r_mobile_no}</div>
              </div>

              <div class="row">
                <div class="col-lg-3 col-md-4 label">Email</div>
                <div class="col-lg-9 col-md-8">{user.r_email}</div>
              </div>
