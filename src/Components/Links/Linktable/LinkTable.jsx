...
export default function LinkTable() {
    ...
    const columns = [
       ...
       ,
        { field: "u_link_tittle", headerName: "Title" ,width: 200},
        ...
        { field: "u_file ", headerName: "File",width: 200 },
        {
            ...
            sortable: false,
            renderCell: (params) => (
                <Link to={'/services/editlink/'+params.row.u_id}>
    ...
    const handleConfirmSubmit = async () => {
        try {
            await apiClient.delete(api.Linksbyid  + selectedItem.u_id);
        ...
        <div>
            ...
            <main id="main" className="main">
                <div className="pagetitle">
                    <h1 className='maintitle'>All Links</h1>
                    <nav>
                        <ol className="breadcrumb">
                            <li className="breadcrumb-item">Home</li>
                            <li className="breadcrumb-item">Service</li>
                            <li className="breadcrumb-item active">All Links </li>
                        </ol>
                    </nav>
                </div>
